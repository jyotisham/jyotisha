...
def panchaanga_json_comparer(city, year):
  ...
  panchaanga = annual.get_panchaanga(city=city, year=year, compute_lagnas=False,
...
def test_adhika_maasa_computations_2009():
  city = City('Chennai', "13:05:24", "80:16:12", "Asia/Calcutta")
  panchaanga_2009 = annual.get_panchaanga(city=city, year=2009, compute_lagnas=False,
                                          allow_precomputed=False)
