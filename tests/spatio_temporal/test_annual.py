...
def test_panchanga_chennai_19():
  ...
  if panchangam.__str__(floating_point_precision=4) != panchangam_expected_chennai_19.__str__(
      floating_point_precision=4):
  ...
  assert panchangam.__str__(floating_point_precision=4) == panchangam_expected_chennai_19.__str__(
    floating_point_precision=4)
...
def test_panchanga_orinda():
  ...
  if panchangam.__str__(floating_point_precision=4) != panchangam_expected_orinda_19.__str__(
      floating_point_precision=4):
    ...
    panchangam_expected_orinda_19.dump_to_file(filename=os.path.join(TEST_DATA_PATH, 'Orinda-2019-expected.json.local'),
                                               floating_point_precision=4)
  assert panchangam.__str__(floating_point_precision=4) == panchangam_expected_orinda_19.__str__(
    floating_point_precision=4)
