...
def test_get_angam_data():
  assert zodiac.get_angam_data(2444961.54042, 2444962.54076, AngaType.TITHI, ayanamsha_id=Ayanamsha.CHITRA_AT_180) == [
  ...
  assert zodiac.get_angam_data(2444961.54042, 2444962.54076, AngaType.YOGA, ayanamsha_id=Ayanamsha.CHITRA_AT_180) == [
    (8, 2444962.18276057)]
  assert zodiac.get_angam_data(2444961.54042, 2444962.54076, AngaType.KARANA, ayanamsha_id=Ayanamsha.CHITRA_AT_180) == [
