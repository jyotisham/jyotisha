...
\newcommand{\tamil}[1]{%
{\fontspec[Scale=0.85,FakeStretch=0.9,Path=../fonts/]{NotoSansTamil-Regular.ttf} \footnotesize #1}}
\newcommand{\kalas}[1]{%
\setsepchar{ }
\readlist\arg{#1}
...
\parbox[c][3em][c]{0.9\linewidth}{\centering\small\textcolor{RoyalBlue}{#7}}\\\vfill%Festivals
#6%Rahu, Yama etc
\clearpage
}
