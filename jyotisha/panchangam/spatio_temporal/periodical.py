...
class Panchangam(common.JsonObject):
    ...
    def compute_angams(self, compute_lagnams=True):
        ...
        # year
        [prev_day_yy, prev_day_mm, prev_day_dd] = swe.revjul(self.jd_start_utc - 1)[:3]
    ...
    def assign_amavasya(self, debug_festivals=False):
        for d in range(1, self.duration + 1):
            [y, m, dt, t] = swe.revjul(self.jd_start_utc + d - 1)
            # Amavasya Tarpanam
    ...
    def update_festival_details(self):
        ...
        self.assign_shraaddha_tithi(debug_shraaddha_tithi=False)
