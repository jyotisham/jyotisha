  ...
  for d in range(1, jyotisha.panchangam.temporal.MAX_SZ - 1):
    ...
    for tithi_ID, tithi_end_jd in panchangam.tithi_data[d]:
      ...
      if tithi_end_jd is None:
        ...
        if tithi_ID % 15 == 0:
          paksha = '%s►%s' % (
          paksha, jyotisha.panchangam.temporal.hour.Hour(24 * (tithi_end_jd - jd)).toString(format=panchangam.fmt))
    ...
    for yoga_ID, yoga_end_jd in panchangam.yoga_data[d]:
      ...
      if yoga_end_jd is None:
        ...
        yoga_data_str = '%s; %s►%s (%s)' % (yoga_data_str, yoga,
                                            jyotisha.panchangam.temporal.hour.Hour(
                                              24 * (yoga_end_jd - panchangam.jd_sunrise[d])).toString(format='gg-pp'),
