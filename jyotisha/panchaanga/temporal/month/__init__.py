...
class SiderialSolarBasedAssigner(LunarMonthAssigner):
  def assign(self):
    ...
    is_adhika = NakshatraDivision(last_new_moon.jd_end, ayanaamsha_id=self.ayanaamsha_id).get_solar_raashi() == \
                NakshatraDivision(this_new_moon.jd_end, ayanaamsha_id=self.ayanaamsha_id).get_solar_raashi()
