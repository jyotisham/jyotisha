...
def compute_events(panchaanga, json_file):
  panchaanga.festival_id_to_days = {}  # Resetting it
  ...
  for d in range(1, MAX_SZ):
    ...
    for event_name in event_rules:
      ...
      if anga_type == 'tithi' and month_type == 'lunar_month' and \
        ...
        if daily_panchaanga.sunrise_day_angas.tithi_at_sunrise == 30 and daily_panchaangas[d + 1].sunrise_day_angas.tithi_at_sunrise == 2 and \
            daily_panchaangas[d + 1].lunar_month_sunrise == month_num:
