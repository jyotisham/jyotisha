...
if __name__ == '__main__':
    city = spatio_temporal.City.get_city_from_db("sahakAra nagar, bengaLUru")
    common_panchaanga = annual.get_panchaanga_for_shaka_year(city=city, year=1942, computation_system=ComputationSystem.MULTI_NEW_MOON_SIDEREAL_MONTH_ADHIKA__CHITRA_180)
