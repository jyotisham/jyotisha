...
It uses ephemeris positions to (somewhat
accurately) calculate important aspects of a day, particularly the five
*aṅgas*, viz. *tithi* (moon phase), *nakshatram* (asterism), *yoga*,
*karaṇam* and *vāra*, and also the occurrence of various Hindu
festivals, which are usually decided by elaborate rules dependent on the
(combinations of the) *aṅgas*.
"""
