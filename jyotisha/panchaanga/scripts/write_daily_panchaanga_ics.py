...
def writeDailyICS(panchaanga, script=sanscript.DEVANAGARI, compute_lagnams=True):
  ...
  for d in range(1, jyotisha.panchaanga.temporal.MAX_SZ - 1):
    ...
    # braahma = jyotisha.panchaanga.temporal.Time(24 * (panchaanga.daily_panchaangas[d].day_length_based_periods.braahma.jd_start - jd)).toString(format=panchaanga.fmt)
    # pratahsandhya = jyotisha.panchaanga.temporal.Time(24 * (panchaanga.daily_panchaangas[d].day_length_based_periods.praatas_sandhyaa.jd_start - jd)).toString(format=panchaanga.fmt)
    # pratahsandhya_end = jyotisha.panchaanga.temporal.Time(24 * (panchaanga.daily_panchaangas[d].day_length_based_periods.praatas_sandhyaa_end.jd_start - jd)).toString(format=panchaanga.fmt)
    # sangava = jyotisha.panchaanga.temporal.Time(24 * (panchaanga.daily_panchaangas[d].day_length_based_periods.saangava.jd_start - jd)).toString(format=panchaanga.fmt)
    # madhyaahna = jyotisha.panchaanga.temporal.Time(24 * (panchaanga.daily_panchaangas[d].day_length_based_periods.madhyaahna.jd_start - jd)).toString(format=panchaanga.fmt)
    # madhyahnika_sandhya = jyotisha.panchaanga.temporal.Time(24 * (panchaanga.daily_panchaangas[d].day_length_based_periods.maadhyaahnika_sandhyaa.jd_start - jd)).toString(format=panchaanga.fmt)
    # madhyahnika_sandhya_end = jyotisha.panchaanga.temporal.Time(24 * (panchaanga.daily_panchaangas[d].day_length_based_periods.maadhyaahnika_sandhyaa_end.jd_start - jd)).toString(format=panchaanga.fmt)
    ...
    sayahna = jyotisha.panchaanga.temporal.hour.Hour(24 * (panchaanga.daily_panchaangas[d].day_length_based_periods.saayaahna.jd_start - jd)).toString(
      format=panchaanga.fmt)
    # sayamsandhya = jyotisha.panchaanga.temporal.Time(24 * (panchaanga.daily_panchaangas[d].day_length_based_periods.saayaM_sandhyaa.jd_start - jd)).toString(format=panchaanga.fmt)
    # sayamsandhya_end = jyotisha.panchaanga.temporal.Time(24 * (panchaanga.daily_panchaangas[d].day_length_based_periods.saayaM_sandhyaa_end.jd_start - jd)).toString(format=panchaanga.fmt)
    # ratriyama1 = jyotisha.panchaanga.temporal.Time(24 * (panchaanga.daily_panchaangas[d].day_length_based_periods.raatri_yaama_1.jd_start - jd)).toString(format=panchaanga.fmt)
    # sayana_time = jyotisha.panchaanga.temporal.Time(24 * (panchaanga.daily_panchaangas[d].day_length_based_periods.shayana.jd_start - jd)).toString(format=panchaanga.fmt)
