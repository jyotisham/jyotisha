...
def send_panchaanga(channel_id, token, computation_system_str, md_url_base, html_url_base):
  ...
  md_url = "%s/%04d_monthly/%04d-%02d/%04d-%02d-%02d.md" % (out_path_md, today.year, today.year, today.month, today.year, today.month, today.day)
  ...
  html_url = "%s/%04d_monthly/%04d-%02d/%04d-%02d-%02d" % (out_path_html, today.year, today.year, today.month, today.year, today.month, today.day)
