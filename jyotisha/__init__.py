...
Note on swiss ephemeris API: Please don't call it directly - there should always a layer inbetween the ephemeris API and our logic. This allows us to easily adjust to ephemeris API changes, and to ensure correctness (eg. sending time in UTC rather than ET time scale).
"""